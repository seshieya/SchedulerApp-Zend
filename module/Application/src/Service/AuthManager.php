...
class AuthManager
{
     ...
     */
    //todo Angela : if want to add a rememberme, can add a another parameter here. See the ZF3 sample (AuthController)
    public function login($username, $password, $dbPassword)
    {   
        ...
        $authAdapter->setDbPassword($dbPassword);
